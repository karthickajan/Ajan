...
var Location = class _Location {
   ...
   *
   */
  go(path, query2 = "", state = null) {
    this._locationStrategy.pushState(state, "", path, query2);
    this._notifyUrlChangeListeners(this.prepareExternalUrl(path + normalizeQueryParams(query2)), state);
  }
  /**
   ...
   * @param state Location history state.
   */
  replaceState(path, query2 = "", state = null) {
    this._locationStrategy.replaceState(state, "", path, query2);
    this._notifyUrlChangeListeners(this.prepareExternalUrl(path + normalizeQueryParams(query2)), state);
  }
  /**
...
@angular/animations/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-EFMFAR7X.js.map
